...
public class ProjectController {
  ...
  @PostMapping("form2")
  public void add2(String title, HttpSession session) throws Exception {
    session.setAttribute("title", title);
  }

  @PostMapping("form3")
  public void add3(String content, String startDate, String endDate, HttpSession session, Model model) throws Exception {
